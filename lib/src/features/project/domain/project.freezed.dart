...
class _$ProjectImpl implements _Project {
  ...
  @override
  String toString() {
    return 'Project(name: $name, description: $description, url: $url, iconCodePoint: $iconCodePoint, iconFontFamily: $iconFontFamily, iconFontPackage: $iconFontPackage, screenshotPath: $screenshotPath, technologies: $technologies, links: $links)';
  }
