...
class _$ExperienceImpl implements _Experience {
  ...
  @override
  String toString() {
    return 'Experience(job: $job, company: $company, description: $description, url: $url, isPresent: $isPresent, startYear: $startYear, startMonth: $startMonth, endYear: $endYear, endMonth: $endMonth, technologies: $technologies, links: $links)';
  }
